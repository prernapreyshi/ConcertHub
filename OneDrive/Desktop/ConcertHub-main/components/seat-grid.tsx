...
export function SeatGrid({ onSeatClick, disabled }: SeatGridProps) {
  ...
  const getSeatClasses = (seat: Seat) => {
    const base =
      "relative flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-t-lg text-xs font-medium transition-all duration-200"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-max flex flex-col items-center gap-2 py-4">
